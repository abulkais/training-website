    ...
    <div class="modal-dialog1">
        <div class="modal-content" style="background-color:#fff; padding:0;">
            ...
            <div class="modal-body" style="padding:30px;">
                <form action="mail" method="post"  onsubmit="return formvalidatec2();">
                    ...
                    <div class="form-group">
                        <input class="form-control modal_form_styling" type="date" name="date" minlength="01-01-2022" placeholder=" " required>
                    </div>

                    <div class="form-group">
                        <input type="email" class="form-control modal_form_styling" name="email" placeholder="Email*" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required>
                    </div>
                    ...
                    <div class="country-form-design">
                        ...
                        <input name="number" placeholder="Phone Number*" style="border:none;" maxlength="10" minlength="10" autocomplete="off" type="tel" pattern="^[0-9]\d*$" onkeypress="return number_e(event)">
                    </div>
                    <p></p>

                    <center>
                        <div id="captha" class="g-recaptcha" data-sitekey="6Ldii1siAAAAACObLfaWSS0DVCYZdeXI4YdkdBKw" data-callback="verifyCaptcha" style="width:100%">
                        </div>
                    </center>
                    <p id="captchamandatoryc2" style="text-align:center; color:red; padding: 10px 0px;     font-size: 15px;"></p>

                    <div class=" form-conn mt-2">
                        <input  name="coursedate" type="submit" class="course_modal_btn w-100 formbuttonhide" value="Submit Now">
...
<div class="modal" id="enquir_now">
    <div class="modal-dialog1">
        <div class="modal-content" style="background-color:#fff; padding:0px;">
            ...
            <div style="box-shadow: 0 0 5px 0 rgb(0 0 0 / 20%);">
                <div class="modal-header" style="padding:20px 20px 0px 20px; ">
                    <h5 class="modal-title course_modal_title"> <img src="assets-new/img/icons/started.webp" alt="Started">I'm interested in the program</h5>
                    <button type="button" class="course_modal_close" data-dismiss="modal">&times;</button>
                </div>
            </div>
            ...
            <div class="modal-body" style="padding:30px;">
                <form action="mail" method="post"  onsubmit="return formvalidatec3();">
                    ...
                    <div class="form-con">
                        <div class="did-floating-label-content">
                            <input class="did-floating-input modal_form_styling" type="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" placeholder=" " required>
                    ...
                    <div class="country-form-design">
                        ...
                        <input name="number" placeholder="Phone Number*" style="border:none;" maxlength="10" minlength="10" autocomplete="off" type="tel" pattern="^[0-9]\d*$" onkeypress="return number_e(event)" required>
                    </div>
                    <br>

                    <div class="form-con">
                        <div class="floating-label">
                            <textarea class="floating-input floating-textarea modal_form_styling" style="height:auto;" rows="3" name="query" placeholder=" "></textarea>
                    ...
                    <p id="captchamandatoryc3" style="text-align:center; color:red; padding: 10px 0px; font-size: 15px;"></p>


                    <div class=" form-conn mt-2">
                        <input  type="submit" class="course_modal_btn w-100 formbuttonhide" name="all_form_submit" value="Submit">
                        <div  class="course_modal_btn w-100 formbuttonshow" style="display:none; text-align:center; cursor: not-allowed! important; opacity: 0.4;" disabled>Please wait</div>
                    </div>
...
<div class="modal" id="Apply_now">
    ...
    <div class="modal-dialog1">
        <div class="modal-content" style="background-color:#fff; padding:0px;">
            ...
            <div style="box-shadow: 0 0 5px 0 rgb(0 0 0 / 20%);">
                <div class="modal-header" style="padding:20px 20px 0px 20px; ">
                    <h5 class="modal-title course_modal_title"> <img src="assets-new/img/icons/apply_icon.webp" alt="Apply Now"> Apply Now</h5>
                    <button type="button" class="course_modal_close" data-dismiss="modal">&times;</button>
                </div>
            </div>
            ...
            <!-- Modal body -->
            <div class="modal-body" style="padding:30px;">
                <form action="mail" method="post"  onsubmit="return formvalidatec4();">
                    <input type="text" class="hidden" name="nam_mail_no_query_title">
                    ...
                    <div class="form-con">
                        <div class="floating-label">
                            <textarea class="floating-input floating-textarea modal_form_styling" style="height:100%!important;" rows="3" name="query" placeholder=" "></textarea>
                            <label class="labelplace" style="color: #000;"> Query (Optional)</label>
                        </div>
                    </div>
                    ...
                    <p id="captchamandatoryc4" style="text-align:center; color:red; padding: 10px 0px; font-size: 15px;"></p>

                    <div class=" form-conn mt-1">
                        <input  name="all_form_submit" type="submit" class="course_modal_btn w-100 formbuttonhide" value="Apply Now">
                        <div  class="course_modal_btn w-100 formbuttonshow" style="display:none; text-align:center; cursor: not-allowed! important; opacity: 0.4;" disabled>Please wait</div>
                    </div>
                </form>
            </div>
...
<div class="modal" id="dnload_brochure">
    <div class="modal-dialog1">
        <div class="modal-content" style="background-color:#fff; padding:0px;">
            ...
            <!-- Modal body -->
            <div class="modal-body" style="padding:30px;">
                <form action="mail" method="post"  onsubmit="return formvalidatec5();">
                    ...
                    <p id="captchamandatoryc5" style="text-align:center; color:red; padding: 10px 0px; font-size: 15px;"></p>

                    <div class=" form-conn mt-2">
                        <input  name="home-page-submit" type="submit" class="course_modal_btn w-100 formbuttonhide" value="Download Now">
                        <div  class="course_modal_btn w-100 formbuttonshow" style="display:none; text-align:center; cursor: not-allowed! important; opacity: 0.4;" disabled>Please wait</div>
                    </div>
                </form>
            </div>
...
<div class="modal" id="get_certification">
    <div class="modal-dialog1">
        <div class="modal-content" style="background-color:#fff; padding:0px;">
            ...
            <div style="box-shadow: 0 0 5px 0 rgb(0 0 0 / 20%);">
                <div class="modal-header" style="padding:20px 20px 0px 20px; ">
                    <h5 class="modal-title course_modal_title"> <img src="assets-new/img/icons/certificate.webp" alt="Download Sample Certificate"> Download Sample Certificate </h5>
                    <button type="button" class="course_modal_close" data-dismiss="modal">&times;</button>
                </div>
            </div>
            ...
            <div class="modal-body" style="padding:30px;">
                ...
                <form action="mail" method="post"  onsubmit="return formvalidatec6();">
                    <input type="text" class="hidden" name="nam_mail_no_title">
                    <input type="hidden" name="comingfrom" value="Download Sample Certificate  <?php echo $data . $data1; ?>">

                    <div class="form-con">
                        <div class="did-floating-label-content">
                            <input class="did-floating-input modal_form_styling" type="text" name="name" placeholder=" " pattern="[A-Z\sa-z]{3,20}" required>
                            <label class="did-floating-label" style="color: #000;" style="color: #000;">Name*</label>
                        </div>
                    </div>
                    ...
                    <p id="captchamandatoryc6" style="text-align:center; color:red; padding: 10px 0px; font-size: 15px;"></p>


                    <div class="form-conn mt-2">
                        <input name="home-page-submit" type="submit" class="course_modal_btn w-100 formbuttonhide" value="Preview Certificate">
                        <div  class="course_modal_btn w-100 formbuttonshow" style="display:none; text-align:center; cursor: not-allowed! important; opacity: 0.4;" disabled>Please wait</div>
                    </div>
                </form>
            </div>
...
<div class="modal" id="get_refer">
    <div class="modal-dialog1">
        <div class="modal-content" style="background-color:#fff; padding:0px;">
            ...
            <div style="box-shadow: 0 0 5px 0 rgb(0 0 0 / 20%);">
                <div class="modal-header" style="padding:20px 20px 0px 20px; ">
                    <h5 class="modal-title course_modal_title"> <img src="assets-new/img/icons/refer-and-earn.webp" alt="Refer a Friend"> Refer a Friend and get Reward</h5>
                    <button type="button" class="course_modal_close" data-dismiss="modal">&times;</button>
                </div>
            </div>
            <!-- Modal body -->
            <div class="modal-body" style="padding:30px;">
                ...
                <form action="mail" method="post" onsubmit="return formvalidatec7();">
                    <input type="text" class="hidden" name="nam_mail_no_query_title">
                    ...
                    <div class="form-con">
                        <div class="floating-label">
                            <textarea class="floating-input floating-textarea modal_form_styling" style="height:100%;" rows="3" name="query" placeholder=" "></textarea>
                            <label class="labelplace" style="color: #000;"> Query (Optional)</label>
                        </div>
                    </div>
                    ...
                    <p id="captchamandatoryc7" style="text-align:center; color:red; padding: 10px 0px; font-size: 15px;"></p>



                    <div class=" form-conn mt-2">
                        <input type="submit" name="all_form_submit" class="course_modal_btn w-100 formbuttonhide"  value="Get Reward">
                        <div  class="course_modal_btn w-100 formbuttonshow" style="display:none; text-align:center; cursor: not-allowed! important; opacity: 0.4;" disabled>Please wait</div>
                    </div>
                </form>
            </div>
...
<div class="modal" id="download_curriculum">
    <div class="modal-dialog1">
        <div class="modal-content" style="background-color:#fff; padding:0px;">
            ...
            <div style="box-shadow: 0 0 5px 0 rgb(0 0 0 / 20%);">
                <div class="modal-header" style="padding:20px 20px 0px 20px; ">
                    <h5 class="modal-title course_modal_title"> <img src="assets-new/img/icons/download_icon.webp" alt="Download Curriculum">Download Curriculum</h5>
                    <button type="button" class="course_modal_close" data-dismiss="modal">&times;</button>
                </div>
            </div>
            <!-- Modal body -->
            <div class="modal-body" style="padding:30px;">
                ...
                <form action="mail" method="post"  onsubmit="return formvalidatec8();">
                    <input type="text" class="hidden" name="nam_mail_no_title">
                    ...
                    <div class="form-con">
                        <div class="did-floating-label-content">
                            <input class="did-floating-input modal_form_styling" minlength="10" type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" name="email" placeholder=" " required>
                            <label class="did-floating-label" style="color: #000;">Email*</label>
                        </div>
                    </div>
                    ...
                    <p id="captchamandatoryc8" style="text-align:center; color:red; padding: 10px 0px; font-size: 15px;"></p>


                    <div class=" form-conn mt-2">
                        <input  name="home-page-submit" type="submit" class="course_modal_btn w-100 formbuttonhide" value="Download Crriculum">
                        <div  class="course_modal_btn w-100 formbuttonshow" style="display:none; text-align:center; cursor: not-allowed! important; opacity: 0.4;" disabled>Please wait</div>
                    </div>
                        ...
                        <div class="testimonial_owlCarousel owl-carousel container">
                            <div class="testimonials">
                                <div class="testimonial_content">
                                    ...
                                    <div style="color:orange">
                                        <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span style="color:#000; font-weight:bold;">5/5</span>
                            ...
                            <div class="testimonials">
                                <div class="testimonial_content">
                                    ...
                                    <div style="color:orange">
                                        <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star-half"></span> <span style="color:#000; font-weight:bold;">4.9/5</span>
                                    </div>
                                </div>
                                <div class="images_box">
                                    <div class="testimonial_img">
                            ...
                            <div class="testimonials">
                                <div class="testimonial_content">
                                    ...
                                    <div style="color:orange">
                                        <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span class="fa fa-star"></span> <span style="color:#000; font-weight:bold;">4/5</span>
                                    </div>
                                </div>
                                <div class="images_box">
                                    <div class="testimonial_img">
...
<section class="refer-section">
    <div class="container">
        <div class="row" style="align-items:center">
            <div class="col-sm-6 hidden-xs"><img src="assets-new/img/refer-left-img.webp" alt="gift vouchers for training" class="img-fluid" style="width: 100%; height:auto"></div>
            <div class="col-sm-6">
                ...
                <div class="col-sm-6">
                    <div class="form-section">
                        ...
                        <div class="contact-form">
                            <form action="mail" method="post"  onsubmit="return formvalidatec9();">
                                <input type="text" class="hidden" name="nam_mail_no_query_title1">
                                <input type="hidden" name="comingfrom" value=" Inspiring upcoming <?php echo $data . $data1; ?>">
                                <div class="form-col">
                                    <div class="did-floating-label-content">
                                ...
                                <div class="country-form-design" style="height:55px!important; border-radius:100px; box-shadow: none;">
                                    ...
                                    <input name="number" placeholder="Phone Number*" style="border:none; height: auto; color: #000;" maxlength="10" minlength="10" autocomplete="off" type="tel" pattern="^[0-9]\d*$" onkeypress="return number_e(event)">
                                ...
                                <div class="form-col">
                                    <div class="did-floating-label-content">
                                        <select class="did-floating-select" onclick="this.setAttribute('value', this.value);" onchange="this.setAttribute('value', this.value);" value="" name="taining" required type="text">
                                            <option value=""></option>
                                ...
                                <p id="captchamandatoryc9" style="color:red; padding: 10px 0px; font-size: 15px;"></p>

                                <div class="form-col2">
                                    <div class="btn formbuttonhide" > <input href="javascript:void(0)" name="all_form_submit1" type="submit" style="background-color:transparent; border:none; color:#fff;  font-weight:bold;" value="Submit" data-submit-value="Please Wait"></div>
                                    <div  class="btn formbuttonshow" style=" display:none; text-align:center; cursor: not-allowed! important; opacity: 0.4;" disabled>Please wait
                                    </div>
                                </div>

                                <p>By Submit, you agree to our <a href="terms-use.php" style="text-decoration: none;">
                                        terms and conditions</a> and our<a href="privacy-policy.php" style="text-decoration: none;"> privacy policy</a>.</p>
...
<div class="modal" id="coursepage">
    <div class="modal-dialog2">
        <div class="modal-content" style="background-color:#fff; padding:0px;">
            ...
            <div style="box-shadow: 0 0 5px 0 rgb(0 0 0 / 20%);">
                <div class="modal-header" style="padding:20px 20px 0px 20px; ">
                    <h5 class="modal-title course_modal_title"> <img src="assets-new/img/icons/book1.webp" alt="Request a Callback"> Interested in <b style="color: #f9753e;">
                            <?php echo $data ?>
                        </b> Course?</h5>
                    <button type="button" class="course_modal_close" data-dismiss="modal">&times;</button>
                </div>
            ...
            <div class="modal-body" style="padding:20px;">
                <div class="row align-items-center">
                    ...
                    <div class="col-sm-7">
                        <form action="mail" method="post"  onsubmit="return formvalidatec10();">
                            <input type="text" class="hidden" name="nam_mail_no_title">
                            <input type="hidden" name="comingfrom" value="Interested in <?php echo $data . $data1; ?>  ">
                            <div class="form-con">
                                <div class="did-floating-label-content">
                            ...
                            <p id="captchamandatoryc10" style="text-align:center; color:red; padding: 10px 0px; font-size: 15px;"></p>

                            <div class="form-conn mt-1">
                                <input  name="home-page-submit" type="submit" class="course_modal_btn w-100 formbuttonhide" value="Submit">
                                <div  class="course_modal_btn w-100 formbuttonshow" style="display:none; text-align:center; cursor: not-allowed! important; opacity: 0.4;" disabled>Please wait</div>
                            </div>
                        </form>
                        <p style="font-size: 10px; color:#000" class="mt-3">By clicking "Submit" you agree to our <a href="https://kvch.in/terms-use" target="_blank" style="color: #cc0f0f;">terms &
