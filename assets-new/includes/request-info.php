...
<!-- <p id="captchamandatory" style="display:none"></p> -->
...
<div style="position:sticky!important; top:90px!important; ">
    ...
    <div class="course_frm">
        ...
        <hr>
        <form action="mail" method="post" onsubmit="return formvalidate();">
            ...
            <div class="country-form-design-req">
            ...
            <p id="captchamandatory" style="text-align:center; color:red; padding:8px 0px;"></p>


            <div class="form-group mt-2">
                <input  type="submit" name="conatct_form_submit" class="curriculum_box_btn w-100 formbuttonhide" value="Submit">
                <div  class="curriculum_box_btn w-100 formbuttonshow" style=" text-align:center; cursor: not-allowed! important; opacity: 0.4; display: none; " disabled >Please wait</div>
            </div>
