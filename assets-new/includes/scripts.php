...
<script>
    ...
    function formvalidate() {
        if (recaptcha_response.length == 0) {
            document.getElementById("captchamandatory").innerHTML = "captcha is mandatory";
            return false;
        } else {
            $('.formbuttonhide').hide();
            $('.formbuttonshow').show();
    ...
    function formvalidatec2() {
        if (recaptcha_response.length == 0) {
            document.getElementById("captchamandatoryc2").innerHTML = "captcha is mandatory";
            return false;
        } else {
            $('.formbuttonhide').hide();
            $('.formbuttonshow').show();
    ...
    // Enquire Now
    function formvalidatec3() {
        if (recaptcha_response.length == 0) {
            document.getElementById("captchamandatoryc3").innerHTML = "captcha is mandatory";
            return false;
        } else {
            $('.formbuttonhide').hide();
            $('.formbuttonshow').show();
    ...
    // Apply Now
    function formvalidatec4() {
        if (recaptcha_response.length == 0) {
            document.getElementById("captchamandatoryc4").innerHTML = "captcha is mandatory";
            return false;
        } else {
            $('.formbuttonhide').hide();
            $('.formbuttonshow').show();
    ...
    // Download Brochure
    function formvalidatec5() {
        if (recaptcha_response.length == 0) {
            document.getElementById("captchamandatoryc5").innerHTML = "captcha is mandatory";
            return false;
        } else {
            $('.formbuttonhide').hide();
            $('.formbuttonshow').show();
    ...
    // Get Certificate
    function formvalidatec6() {
        if (recaptcha_response.length == 0) {
            document.getElementById("captchamandatoryc6").innerHTML = "captcha is mandatory";
            return false;
        } else {
            $('.formbuttonhide').hide();
            $('.formbuttonshow').show();
    ...
    //refer and earn
    function formvalidatec7() {
        if (recaptcha_response.length == 0) {
            document.getElementById("captchamandatoryc7").innerHTML = "captcha is mandatory";
            return false;
        } else {
            $('.formbuttonhide').hide();
            $('.formbuttonshow').show();
    ...
    //download curriculum
    function formvalidatec8() {
        if (recaptcha_response.length == 0) {
            document.getElementById("captchamandatoryc8").innerHTML = "captcha is mandatory";
            return false;
        } else {
            $('.formbuttonhide').hide();
            $('.formbuttonshow').show();
    ...
    function formvalidatec9() {
        if (recaptcha_response.length == 0) {
            document.getElementById("captchamandatoryc9").innerHTML = "captcha is mandatory";
            return false;
        } else {
            $('.formbuttonhide').hide();
            $('.formbuttonshow').show();
    ...
    //onload popup 
    function formvalidatec10() {
        if (recaptcha_response.length == 0) {
            document.getElementById("captchamandatoryc10").innerHTML = "captcha is mandatory";
            return false;
        } else {
            $('.formbuttonhide').hide();
            $('.formbuttonshow').show();
    ...
    function formvalidatec_dm_course_fees() {
        if (recaptcha_response.length == 0) {
            document.getElementById("captchamandatory_dm_course_fees").innerHTML = "captcha is mandatory";
            return false;
        } else {
            $('.formbuttonhide').hide();
            $('.formbuttonshow').show();
    ...
    function formvalidatec_dm_course_fees2() {
        if (recaptcha_response.length == 0) {
            document.getElementById("captchamandatory_dm_course_fees2").innerHTML = "captcha is mandatory";
            return false;
        } else {
            $('.formbuttonhide').hide();
            $('.formbuttonshow').show();
    ...
    function formvalidatec_dm_course_fees3() {
        if (recaptcha_response.length == 0) {
            document.getElementById("captchamandatory_dm_course_fees3").innerHTML = "captcha is mandatory";
            return false;
        } else {
            $('.formbuttonhide').hide();
            $('.formbuttonshow').show();
    ...
    //Footer form Request Call back 
    function formvalidatec11() {
        if (recaptcha_response.length == 0) {
            document.getElementById("captchamandatoryc11").innerHTML = "captcha is mandatory";
            return false;
        } else {
            $('.formbuttonhide').hide();
            $('.formbuttonshow').show();
