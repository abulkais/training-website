    ...
    <nav class="navbar navbar-fixed-top">
        ...
        <ul class="nav navbar-nav-new pull-right before_login_head">
            ...
            <li class="hidden-xs hidden-sm">
                <center> <a href="linguaskill" target="_blank" style="padding:0px 10px 0px 0px;"><img src="assets-new/img/linguaskill-from-camb.webp" style="width:150px; height:100%;" alt=""></a></center>
            </li>
        ...
        <div class="tabcategory">
            <div class="container no-padding tabcategorylist">
                <ul class="nav nav-tabs categoryvisible" id="discoverysearchtab">
                    ...
                    <li><a data-toggle="tab" href="#searchTab_1">Trending Courses <i class="fa fa-angle-down fa-lg" aria-hidden="true" style="color:#000;"></i></a></li>
                ...
                <ul class="menu-main-navigation menu clearfix">
                    ...
                    <li class="menu-item-has-children">
                        <div class="new_head_ham slide-menu-control" style="color: #fff;" aria-label="humburger" role="button" data-target="test-menu-left" data-action="open">
                            <a href="javascript:void(0)">Trending Courses <i class="fa fa-angle-down fa-lg" aria-hidden="true" style="color:#000; font-weight:bold"></i></a>
                        </div>
                    </li>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="mail" method="post" onsubmit="return formvalidateb9();">
                    ...
                    <div style=" border-radius: 10px;display: flex;border: 1px solid #a6a6a6; height: 45px!important;">
                        ...
                        <input name="number" placeholder="Phone Number" style="border:none; height: auto; color: #000; border-radius: 0px 4px 4px 0px; width:100%" maxlength="10" minlength="10" autocomplete="off" type="tel" pattern="^[0-9]\d*$" onkeypress="return number_e(event)">
                    ...
                    <p id="captchamandatoryb9" style="text-align:center; color:red; padding: 0px 0px 10px; font-size: 15px;"></p>

                    <div class="form-conn">
                        <input name="organization_submit" type="submit" value="Submit" class="btn-submit formbuttonhide2">
                        <div class="btn-submit formbuttonshow2" style="display:none; text-align:center; cursor: not-allowed! important; opacity: 0.4; border:none;" disabled>Please wait</div>
                    </div>
                </form>
            </div>
        </div>
