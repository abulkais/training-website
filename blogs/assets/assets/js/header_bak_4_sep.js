...
/***********************END*************************************/
/********************Local storage*******************************/
window.onload = function() {  // setTimeout(delay1, 5000);
    //alert("hello");
	 var pageurl=window.location.href.indexOf('certificate-form.html');
	 var pageurlSecond=window.location.href.indexOf('verifycert.html');
...
/*************************END lset local storage value**********/

/****************************check form5 start here********************/
// Captcha Script
