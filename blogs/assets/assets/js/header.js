...
/***********************verify page code to display popup*************************************/
	...
	//alert('new header html');// setTimeout(delay1, 5000);
	 ...
	 //var pageurlsecond=window.location.href.indexOf('certificate');
       ...
       if(url=='https://kvch.in/certificate-form')
       {
           var pageurlverifycert1='cert1';
       }
	   ...
	   if(url=='https://kvch.in/verifycert')
        ...
        if(url=='https://kvch.in/verifycert.php')
         {
           var pageurlverifyver1='verify1';
         }
	   
       if(url=='https://kvch.in/events.html')
         {
           
            var pageurlevents='events';
         }

          if(url=='https://kvch.in/events')
         {
           var pageurlevents1='events1';
         }
   ...
   //alert('this is value'+cvalue);
    if(cvalue==null)
      { 
          //alert('value'+pageurl);
         if(pageurlverifycert!='cert' && pageurlverifyver!='verify' && pageurlevents!='events' && pageurlverifycert1!='cert1' && pageurlverifyver1!='verify1' && pageurlevents1!='events1')//if(pageurl != 29|| pageurlSecond = -1)
         {  // alert('popup');
...
//var bookbtnMobi = document.getElementById("bookbtnMobile");
...
document.getElementById('searchboxcourses-title').style.display="none";
//   $('#searchboxcourses-title').css('display','none');
}
...
function checkform5(theform) {
    ...
    if (why1 != "") {
    	...
    	$("#submitSub").css('pointer-events','none');
