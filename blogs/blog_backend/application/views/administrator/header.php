        ...
        <div class="navbar-wrapper" style="background:#fff;">
            <div class="navbar-logo">
                ...
                <a href="<?php echo base_url(); ?>administrator/dashboard">
                 <?php if($this->session->userdata('image') != ""){ ?>
                        <img src="<?php echo base_url(); ?>assets/images/kvch_logo.png" alt="Site Logo" class="img-fluid" style="width: auto; height: 30px;" >
                    <?php }else{ ?>
                         <img class="img-fluid" src="<?php echo base_url(); ?>admintemplate/assets/images/kvch_logo.png" alt="Theme-Logo" />
                    <?php } ?>
            ...
            <div class="navbar-container container-fluid">
                <div>
                    <ul class="nav-left">
                        <li>
                            <a id="collapse-menu" href="#" style="color:#000;">
                                <i class="ti-menu"></i>
                            </a>
                        </li>
                        <li>
                            <a href="#!" onclick="javascript:toggleFullScreen()" style="color:#000;">
