<?php 
	...
	public function multipleImageUpload($images,$dataID){
		...
		public function add_blog($page = 'add-blog')
		{
			...
			$data['metakeywords'] = $this->input->post('metakeywords');
			$data['canonicallink'] = $this->input->post('canonicallink');
			...
			$this->form_validation->set_rules('canonicallink', 'Canonical Link', 'required');
