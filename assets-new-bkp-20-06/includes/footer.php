...
<div class="modal" id="request_callback1">
    <div class="modal-dialog1">
        <div class="modal-content" style="background-color:#fff; padding:0px;">
            ...
            <div class="modal-body" style="padding:30px;">
                <form action="mail" method="post" id="requestcallbackfooter">
    ...
    color: #000!important;
                    ...
                    <div class=" form-conn mt-2">
                        <input id="requestcallbackhide" type="submit" class="course_modal_btn w-100" name="footer_requestcallback" value="Submit">
                        <div id="requestcallbackshow" class="course_modal_btn w-100" style="display: none; text-align:center; cursor:none;" disabled>Please wait</div>
                    </div>
