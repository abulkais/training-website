...
<style>
    ...
    .country-form-design-need input {
        width: 100%;
    }

    .country-form-design-need select {
        width: 90px !important;
    }
</style>

<!-- need customized start -->
<div class="container mt-5">
    <div class="need_customized">

        <div class="row">
            <div class="col-sm-9" style="padding: 40px 30px;">
                <h4 style="font-weight:600; color:#fff;">Need Customized Curriculum? Request Now</h4>
                <p style="color:#fff;">Structure your learning and get a certificate to prove it.</p>
                ...
                <form action="mail" method="post" id="submitformneedc">
                    ...
                    <input type="hidden" name="comingfrom"
                        value="Need Customized Curriculum <?php echo $data . $data1; ?>">
                    ...
                    <div class="row">
                        ...
                        <!-- <div class="col-sm-4">
                                <div class="form-group">
                                    <input type="tel" id="training3" name="number" onkeypress="return number_e(event)" placeholder="Mobile Number*" class="form-control course-form-no-res" pattern="^[1-9]\d*$" required>
                                </div>
                            </div> -->
                        <div class="col-sm-4">
                            <div class="country-form-design-need">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <div id="buttonhideneedc"
                                    style="width:100%; cursor:pointer; text-align:center; background-color:orange; border-radius:5px; color:#fff;  padding:8px 30px;">
                                    <input type="submit" name="mail_number"
                                        style="font-weight:600; background-color:orange; color:#fff; border:none"
                                        value="Request Now"> <i class="fa fa-send"></i>
                                </div>
                                <div id="buttonshowneedc"
                                    style=" display: none; width:100%; cursor:pointer; text-align:center; background-color:orange; border-radius:5px; color:#fff;  padding:8px 30px;">
                                    <div style=" text-align:center; cursor:none;" disabled>Please wait <i
                    ...
                    <p style="padding-bottom:0; margin-bottom:0; color:#fff; font-size:13px;">By Request Now, you agree
                        to our <a href="https://kvch.in/terms-use" style="color:yellow;">terms and conditions</a> and <a
                            href="https://kvch.in/privacy-policy" style="color:yellow;"> our privacy policy.</a></p>
            ...
            <div class="col-sm-3">
                <figure style="float: right; padding:0; margin:0;">
                    <img src="assets-new/img/icons/women.webp" class="course-custmize-img"
                        alt="Need Customized Curriculum">
                </figure>
            </div>
        </div>
    </div>
