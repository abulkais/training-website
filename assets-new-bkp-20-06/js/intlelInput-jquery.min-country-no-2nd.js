...
!(function (a) {
              ...
              if (
                ...
                this.d.allowDropdown &&
                  ...
                  this.preferredCountries.length &&
                    (this._g(this.preferredCountries, "iti__preferred"),
                    this._e2(
                      "li",
                      {
                        class: "iti__divider",
          ...
          },
          {
            ...
            value: function (a, b) {
              for (var c = "", d = 0; d < a.length; d++) {
                var e = a[d];
                (c += "<li class='iti__country "
                  .concat(b, "' tabIndex='-1' id='iti-item-")
                  ...
                  (c += "<span class='iti__country-name'>".concat(
                    e.name,
                    "</span>"
                  )),
                  (c += "<span class='iti__dial-code'>+".concat(
                    e.dialCode,
                    "</span>"
                  )),
                  (c += "</li>");
            ...
            value: function () {
              ...
              if (
                ...
                var d = this.a.getBoundingClientRect(),
                  ...
                  i = f - g > e;
                if (
                  (this._n2(this.m, "iti__country-list--dropup", !h && i),
                  this.d.dropdownContainer)
                ) {
  ...
  (b.intlTelInputGlobals.loadUtils = function (a) {
    ...
    (b.intlTelInputGlobals.version = "16.0.13");
