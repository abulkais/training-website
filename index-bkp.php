...
.country-form-design {
        ...
        .home_banner_slide1 {
            background-image: url('assets-new/img/banner/kvch_banner2.webp');
...
<body style="padding-right: 0px!important; margin-right:0px!important">
    ...
    <div class="slideshow">
        <div class="slider">
            <!-- <div class="item" data-toggle="modal" style="display:block; margin:0;" data-target="#Apply_now">
                <a href="javascript:void(0)" title="Walk in Drive">
                    <div class="home_banner_slide6">
            ...
            <div class="item">
                <a href="6-months-industrial-training-noida" target="_blank" title="4/6 Months/Weeks Summer Training">
    ...
    <section class="strategic-section" style="padding-bottom:0px; padding-top:0px;">
        <div class="container" style="max-width: 770px; width:100%;">
            ...
            <ul class="clearfix" id="all-courses">
                ...
                <li>
                    <div><img src="assets-new/img/sap-logo.webp" class="img-fluid" alt="sap logo"></div>
                </li>
                <li>
                    ...
                    <div class="program">
                        ...
                        <form action="mail" method="post" id="submitformrequestfooter">
                            ...
                            <ul class="row">
                                ...
                                <li class="col-sm-4 col-md-3">
                                    <!-- <div class="did-floating-label-content">
                                        <input type="tel" class="did-floating-input country_flag" onkeypress="return number_e(event)" placeholder="Mobile no*" name="number" pattern="^[1-9]\d*$" minlength="10" maxlength="16" required>
                                    </div> -->
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        <form action="mail" method="post" id="submitformreff">
                            ...
                            <!-- <div class="form-con">
                                <div class="did-floating-label-content">
                                    <input type="tel" name="number" minlength="10" maxlength="16"  onkeypress="return number_e(event)" pattern="^[1-9]\d*$" class="did-floating-input  modal_form_styling number-res country_flag" style="padding-left: 0px!important; width: 370px!important;" placeholder="Mobile Number*" required>
                                </div>
                            </div> -->
