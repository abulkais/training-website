...
if (isset($_POST['Linguaskill_form'])) {
   ...
   if ($name != ""  && isset($isemailValid)  &&  isset($isNumValid) && $isNumValid != 0 && $gender != "" && $dob != "") {
      $html   = " Hi," . "<br>" . "We have received Enquiry from KVCH.IN for : " . $pagename . "<br>" . "<b>Full Name : </b>" . $name . " <br> <b>Email : </b>" . $email . "<br> <b> Contact No :  </b> " . $countrycode . $number  . "<br> <b> DOB : </b>" . $dob . " <br> <b> Query  :  </b> " . $query .  "<br><b> IP Address : </b> " . $_SERVER['REMOTE_ADDR'] . "<br><b> Device : </b> " . strtolower($_SERVER["HTTP_USER_AGENT"]) . "<br><b> Date : </b> " . date('D-M-Y  h-i-s A');
